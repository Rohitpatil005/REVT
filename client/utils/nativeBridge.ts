declare global {
  interface Window {
    electron?: {
      savePdf: (org: string, fileName: string, arrayBuffer: ArrayBuffer) => Promise<{ fullPath: string }>;
...
export async function savePdfToAppFolder(org: string, file: File, fileName: string): Promise<string | null> {
