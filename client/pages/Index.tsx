        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border bg-background/80 px-3 py-1 text-xs text-muted-foreground">
              <span className="h-2 w-2 rounded-full bg-primary" /> Windows-ready
              · Free-tier cloud
            </div>
            ...
            <div className="text-xs text-muted-foreground">
              Plan: start with free tiers (Supabase/Netlify/Vercel). Package as
              a Windows app later with Electron.
            </div>
          </div>
            ...
            <div className="relative grid gap-4 sm:grid-cols-2">
              <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Use object storage buckets to keep invoice PDFs with
              ...
              <Card className="sm:col-span-2">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>
                    Customer memory and address suggestions
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-sm text-muted-foreground">
                  Reduce repetitive typing by remembering prior addresses,
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Electron or Tauri with the same codebase
            </CardDescription>
          </CardHeader>
          <CardContent className="text-sm text-muted-foreground space-y-2">
            <p>
              This UI is production-ready for the web. Wrap it as a desktop app
